...
const mockSocials: SocialRow[] = [
  { platform: "github", url: "https://github.com/AGASTYA12343534", username: "AGASTYA12343534", order: 1 },
  {
    platform: "linkedin",
    url: "https://linkedin.com/in/AGASTYA12343534",
    username: "AGASTYA12343534",
    order: 2,
  },
  { platform: "twitter", url: "https://twitter.com/AGASTYA12343534", username: "AGASTYA12343534", order: 3 },
];
...
describe("Contact", () => {
  const email = "agastya110805@gmail.com";
  ...
  it("renders social links with accessible labels", () => {
    render(<Contact socials={mockSocials} email={email} />);
    expect(screen.getByLabelText("github: AGASTYA12343534")).toBeTruthy();
    expect(screen.getByLabelText("linkedin: AGASTYA12343534")).toBeTruthy();
    expect(screen.getByLabelText("twitter: AGASTYA12343534")).toBeTruthy();
  });

  it("renders external social links that open in a new tab (target=_blank)", () => {
    render(<Contact socials={mockSocials} email={email} />);
    const githubLink = screen.getByLabelText("github: AGASTYA12343534");
    expect(githubLink.getAttribute("href")).toBe("https://github.com/AGASTYA12343534");
  ...
  it("renders all social icons in sorted order", () => {
    const unsorted: SocialRow[] = [
      {
        platform: "twitter",
        url: "https://twitter.com/AGASTYA12343534",
        username: "AGASTYA12343534",
        order: 3,
      },
      { platform: "github", url: "https://github.com/AGASTYA12343534", username: "AGASTYA12343534", order: 1 },
