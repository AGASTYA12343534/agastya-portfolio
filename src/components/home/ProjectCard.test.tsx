...
const base: MergedProject = {
  ...
  description: "A thing.",
  homepage: null,
  htmlUrl: "https://github.com/AGASTYA12343534/rippl",
};
...
describe("ProjectCard", () => {
  ...
  it("renders null stats as em-dash", () => {
    render(<ProjectCard project={{ ...base, stars: 0, forks: null }} />);
  ...
  it("renders Code link pointing to GitHub URL", () => {
    ...
    expect(codeLink).toHaveAttribute("href", "https://github.com/AGASTYA12343534/rippl");
  });
