...
export function SkillCard({ name }: { name: string; iconPath?: string }) {
  return (
    <motion.li
    ...
    >
      <span className="bg-surface-2 relative flex size-12 items-center justify-center rounded-xl p-1.5 text-foreground">
        <SkillIcon name={name} className="size-6 object-contain" />
      </span>
